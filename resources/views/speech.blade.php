...
<html>
            ...
            <script>
                "use strict";
                  ...
                  if (annyang) {
                    ...
                    var commands = {
                      'hello (there)':        hello,
                      'paralelepipedo (there)':        paralelepipedo,
    ...
    <body>
        ...
        <section id="section_hello">
            <p>Let's Start,</p>
            <p class="voice_instructions">
                Say "Hello!"
            </p>
            <p class="hidden" id="hello">
                Show!
            </p>
        </section>
        ...
        <!-- <section id="section_image_search">
            ...
            <div class="hidden" id="flickrGallery">
            </div>
        </section> -->
        ...
        <section id="section_biz_use">
            ...
            <img class="hidden" id="tpsreport" style="max-width: 300px;" src="https://upload.wikimedia.org/wikipedia/commons/7/75/Tps_report.png">
            </img>
        </section>        
        ...
        <div class="hidden" id="unsupported">
            ...
            <p>
                Please visit
                <a href="http://www.annyangjs.com/">
                    http://www.annyangjs.com/
                </a>
                in a desktop browser like Chrome.
            </p>
        </div>
