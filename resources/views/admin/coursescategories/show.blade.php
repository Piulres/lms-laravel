...
@section('content')
    <div class="back-button">
        <a href="{{ route('admin.coursescategories.index') }}" class="waves-effect waves-light btn-small grey">@lang('global.app_back_to_list')</a>
    </div>
                                ...
                                <tr data-entry-id="{{ $course->id }}">
                                    ...
                                    <td class="actions">
                                        <div class="buttons d-flex justify-content-end">
                                            @can('course_view')
                                            <a href="{{ route('admin.courses.show',[$course->id]) }}" class="waves-effect waves-light btn-small btn-square amber"><i class="material-icons">remove_red_eye</i></a>
                                            @endcan
                                            @can('course_edit')
