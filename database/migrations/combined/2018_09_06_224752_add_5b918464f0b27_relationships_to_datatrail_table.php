...
class Add5b918464f0b27RelationshipsToDatatrailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('datatrails', function(Blueprint $table) {
            if(Schema::hasColumn('datatrails', 'trail_id')) {
                $table->dropForeign('205152_5b918128d4247');
                $table->dropIndex('205152_5b918128d4247');
                $table->dropColumn('trail_id');
            }
            if(Schema::hasColumn('datatrails', 'user_id')) {
                $table->dropForeign('205152_5b918128edd80');
                $table->dropIndex('205152_5b918128edd80');
