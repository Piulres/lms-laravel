...
class Add5b918464ae7fcRelationshipsToDatacourseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('datacourses', function(Blueprint $table) {
            if(Schema::hasColumn('datacourses', 'course_id')) {
                $table->dropForeign('205151_5b9180e0b143c');
                $table->dropIndex('205151_5b9180e0b143c');
                $table->dropColumn('course_id');
            }
            if(Schema::hasColumn('datacourses', 'user_id')) {
                $table->dropForeign('205151_5b9180e0cdab5');
                $table->dropIndex('205151_5b9180e0cdab5');
