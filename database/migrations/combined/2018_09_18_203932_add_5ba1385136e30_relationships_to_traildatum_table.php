...
class Add5ba1385136e30RelationshipsToTraildatumTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('traildatas', function(Blueprint $table) {
            if(Schema::hasColumn('traildatas', 'user_id')) {
                $table->dropForeign('209360_5ba12639392d9');
                $table->dropIndex('209360_5ba12639392d9');
                $table->dropColumn('user_id');
            }
            if(Schema::hasColumn('traildatas', 'trail_id')) {
                $table->dropForeign('209360_5ba1263954161');
                $table->dropIndex('209360_5ba1263954161');
                $table->dropColumn('trail_id');
            }
            if(Schema::hasColumn('traildatas', 'certificate_id')) {
                $table->dropForeign('209360_5ba1263967eec');
                $table->dropIndex('209360_5ba1263967eec');
