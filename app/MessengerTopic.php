...
class MessengerTopic extends Model
{
    ...
    {
        return $this->hasOne(User::class, 'id', 'sender_id')->withoutGlobalScopes(['team_id', 'created_by_team_id', 'created_by_id']);
    }

    public function receiver()
    {
        return $this->hasOne(User::class, 'id', 'receiver_id')->withoutGlobalScopes(['team_id', 'created_by_team_id', 'created_by_id']);
    }
